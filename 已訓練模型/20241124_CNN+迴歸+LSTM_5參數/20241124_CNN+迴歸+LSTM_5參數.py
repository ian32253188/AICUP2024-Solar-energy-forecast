...
# 確定文件路徑
DataName = r'ExampleTrainData(AVG)\AvgDATA_00_processed.csv'
...
# CNN 部分
regressor.add(Conv1D(filters=64, kernel_size=3, activation='relu', input_shape=(X_train.shape[1], 5)))
...
regressor.save('WeatherCNN_LSTM_'+NowDateTime+'.h5')
print('Model Saved')
...
#============================預測數據============================
#載入模型
regressor = load_model('WeatherCNN_LSTM_2024-11-24T14_04_21Z.h5')
Regression = joblib.load('WheatherRegression_2024-11-24T14_05_57Z')
