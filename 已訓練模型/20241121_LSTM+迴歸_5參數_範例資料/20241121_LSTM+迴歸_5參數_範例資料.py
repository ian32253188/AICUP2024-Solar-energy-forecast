...
# 異常值處理
z_scores = np.abs(stats.zscore(SourceData[['WindSpeed(m/s)','Pressure(hpa)','Temperature(°C)','Humidity(%)','Sunlight(Lux)','Power(mW)']]))
SourceData = SourceData[(z_scores < 3).all(axis=1)]
