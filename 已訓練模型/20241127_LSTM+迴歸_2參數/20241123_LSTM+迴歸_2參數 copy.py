...
#載入訓練資料
# 確定文件路徑
DataName = r'C:\Users\ian32\Downloads\LSTM+迴歸分析(比賽用)\ExampleTrainData(AVG)\AvgDATA_00_光照度與發電量關係修正.csv'
...
#開始訓練
regressor.fit(X_train, y_train, epochs = 25, batch_size = 128)
...
#============================預測數據============================
#載入模型
regressor = load_model('WheatherLSTM_2024-11-27T22_25_39Z.h5')
Regression = joblib.load('WheatherRegression_2024-11-27T22_26_36Z')
